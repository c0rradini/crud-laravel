...
<section class="flex justify-content-center align-items-center position-relative py-4 py-5" style="height: 100vH;">
                ...
                <div class="card mb-5">
                    <div class="card-body p-sm-5">
                        ...
                        <form action="{{ route('register_product') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <input class="form-control" type="text" id="price_cost" name="price_cost"
                                       placeholder="Preço de custo" value="{{old('name')}}">
                            </div>
                            <div class="mb-3">
                                <input class="form-control" type="text" id="price_sale" name="price_sale"
                                                     placeholder="Preço de venda" value="{{old('name')}}">
                            </div>
                            <div class="mb-3">
                                <input class="form-control" type="text" id="qtde" name="qtde"
                                                     placeholder="Quantidade" value="{{old('name')}}">
                            </div>
                            <div>
                                <button class="btn d-block w-100" type="submit"
                                        style="background: rgba(173,73,0,0.95);border-style: none;">Cadastrar
                                </button>
                            </div>
                        </form>
                    </div>
